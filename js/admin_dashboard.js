...
window.app.renderAdminDashboard = () => {
                ...
                const html = `
                    ...
                    <div class="bg-white border border-slate-200/80 rounded-xl border border-white shadow-sm overflow-hidden mb-5">
                        <div class="p-4 border-b border-indigo-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-indigo-50/30">
                            <div>
                                <h3 class="font-bold text-indigo-900 flex items-center gap-2">
                                    ...
                                    Area Summary
                                    <span class="text-[9px] font-bold px-2 py-0.5 rounded-md bg-indigo-100 text-indigo-800 uppercase tracking-wider">Area Matrix</span>
                                </h3>
