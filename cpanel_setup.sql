-- cPanel MySQL Setup Script for Sales360 WEBAPP
-- This script creates the tables based on your database structure and inserts the initial data.
...
INSERT INTO tiv_brands (id, name, models) VALUES
(1, 'TATA', '["TATA ACE EX2", "TATA intra V20", "TATA 407", "TATA 709 EX CH"]'),
(2, 'Ashok Leyland', '["Dost Strong 1 Ton", "Dost Plus 1.2 Ton", "Phoenix 1.2 Ton", "Partner 1.5 Ton", "Partner 3 Ton", "Leo"]'),
(3, 'JAC', '["JAC 1.2 Ton", "JAC 1.5 Ton", "JAC 3 Ton"]'),
(4, 'Eicher', '["EicherPro 1049 CT", "Eicher 1050", "Eicher 1075"]'),
(5, 'Forland', '["Forland 1 Ton", "Forland 1.2 Ton"]'),
(6, 'Mahindra', '["Mahindra Bolero 1 Ton", "Mahindra Bolero 1.2 Ton", "Mahindra Load king OPTIMO"]'),
(7, 'JMC', '["JMC 1.5 Ton", "JMC 3 Ton"]'),
(8, 'SML', '["SML ISUZU 3 Ton"]')
ON DUPLICATE KEY UPDATE id=id;
