...
INSERT INTO users (id, name, role, email, password, territories) VALUES
('u1', 'System Administrator', 'admin', 'admin@acimotors.com', 'password', '[]'),
('u2', 'Md. Shafiqul (AM)', 'am', 'am@acimotors.com', 'password', '["t1", "t2"]'),
('u3', 'Rahim Uddin (SO)', 'so', 'so@acimotors.com', 'password', '["t1"]'),
('u4', 'Karim Hasan (SO)', 'so', 'so2@acimotors.com', 'password', '["t2"]');
...
('t1', 'Dhaka North', 'Dhaka', '["Mirpur", "Uttara", "Savar", "Ashulia"]'),
('t2', 'Dhaka South', 'Dhaka', '["Motijheel", "Jatrabari", "Keraniganj", "Demra"]'),
('t3', 'Chattogram', 'Chattogram', '["Pahartali", "Sitakunda", "Hathazari", "Coxs Bazar"]'),
('t4', 'Rajshahi', 'Rajshahi', '["Rajshahi Sadar", "Bogura Sadar"]'),
('t5', 'Khulna', 'Khulna', '["Khulna Sadar", "Jashore Sadar"]'),
('t6', 'Sylhet', 'Sylhet', '["Sylhet Sadar", "Habiganj Sadar"]'),
('t7', 'Barishal', 'Barishal', '["Barishal Sadar"]'),
('t8', 'Rangpur', 'Rangpur', '["Rangpur Sadar", "Dinajpur Sadar"]');
...
INSERT INTO targets (id, fy, territory_id, upazila, brand, target_qty) VALUES
('tg1', '2025-26', 't1', 'Mirpur', 'Foton', 45),
('tg2', '2025-26', 't1', 'Uttara', 'Foton', 35),
('tg3', '2025-26', 't1', 'Savar', 'Foton', 60),
('tg4', '2025-26', 't1', 'Mirpur', 'Mahindra', 30);
...
INSERT INTO projections (id, fy, month, territory_id, upazila, brand, projection_qty) VALUES
('p1', '2025-26', 'April', 't1', 'Mirpur', 'Foton', 5),
('p2', '2025-26', 'April', 't1', 'Uttara', 'Foton', 3),
('p3', '2025-26', 'April', 't1', 'Savar', 'Foton', 8),
('p4', '2025-26', 'April', 't1', 'Mirpur', 'Mahindra', 4);
